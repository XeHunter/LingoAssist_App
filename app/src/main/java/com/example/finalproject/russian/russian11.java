...
import com.example.finalproject.spanish.spanish11;
import com.example.finalproject.spanish.spanishtest;
import com.google.android.material.bottomsheet.BottomSheetDialog;

public class russian11 extends AppCompatActivity {
    ImageButton ib;
    LinearLayout l1,l2,l3,l4;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_russian11);
        ...
        MediaPlayer mediaPlayer = MediaPlayer.create(this,R.raw.radio);
        mediaPlayer.start();
        ...
        l4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(russian11.this);
        ...
        l1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                button1.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent i = new Intent(russian11.this, russiantest.class);
                        startActivity(i);
                        bottomSheetDialog.hide();
                    }
                });
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(russian11.this, home.class);
                startActivity(i);
                finish();
            }
        });
