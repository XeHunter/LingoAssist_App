...
import com.example.finalproject.german.german3;
import com.example.finalproject.german.german4;
import com.example.finalproject.home;
import com.google.android.material.bottomsheet.BottomSheetDialog;

public class italian3 extends AppCompatActivity {
    ImageButton ib;
    LinearLayout l1,l2,l3,l4;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_italian3);
        ...
        MediaPlayer mediaPlayer = MediaPlayer.create(this,R.raw.women);
        ...
        l2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(italian3.this);
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(italian3.this, home.class);
                startActivity(i);
                finish();
            }
        });
        l3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                button1.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent i = new Intent(italian3.this, italian4.class);
                        startActivity(i);
                        bottomSheetDialog.hide();
                    }
                });
