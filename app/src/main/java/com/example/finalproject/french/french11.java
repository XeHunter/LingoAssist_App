...
public class french11 extends AppCompatActivity {
    ImageButton ib;
    LinearLayout l1,l2,l3,l4;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_french11);
        ...
        MediaPlayer mediaPlayer = MediaPlayer.create(this,R.raw.man);
        mediaPlayer.start();
        ...
        l4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(french11.this);
        ...
        l1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                button1.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent i = new Intent(french11.this, frenchtest.class);
                        startActivity(i);
                        bottomSheetDialog.hide();
                    }
                });
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(french11.this, home.class);
                startActivity(i);
                finish();
            }
        });
