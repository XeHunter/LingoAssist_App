...
public class Agerman8 extends AppCompatActivity {
    ImageView ib;
    EditText e1;
    Button b;
    TextToSpeech tts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agerman8);
        getSupportActionBar().hide();
        ib = findViewById(R.id.ib2);
        e1 = findViewById(R.id.ts1);
        b = findViewById(R.id.b1);
        b1 = findViewById(R.id.mic);
        MediaPlayer mediaPlayer = MediaPlayer.create(this,R.raw.gta8);
        mediaPlayer.start();
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Agerman8.this, home.class);
                startActivity(i);
                finish();
            }
        });
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(Agerman8.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        });
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(Agerman8.this);
                ...
                else
                {
                    ...
                    t1.setText("ich liebe "+e1.getText().toString()+"!");
                    ...
                    button1.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent i = new Intent(Agerman8.this, Agerman9.class);
                            startActivity(i);
                            bottomSheetDialog.hide();
                        }
                    });
