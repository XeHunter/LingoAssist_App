...
public class russian10 extends AppCompatActivity {
    ImageButton ib;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MediaPlayer mediaPlayer = MediaPlayer.create(this,R.raw.pizza);
        mediaPlayer.start();
        ...
        l1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(russian10.this);
        ...
        l4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                button1.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent i = new Intent(russian10.this, russian11.class);
                        startActivity(i);
                        bottomSheetDialog.hide();
                    }
                });
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(russian10.this, home.class);
                startActivity(i);
                finish();
            }
        });
