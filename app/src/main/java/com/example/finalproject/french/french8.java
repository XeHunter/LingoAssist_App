...
public class french8 extends AppCompatActivity {
    Button l1,l2,l3,l4;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_french8);
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(french8.this, home.class);
                startActivity(i);
                finish();
            }
        });
        ...
        l1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(french8.this);
        ...
        l3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                button1.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent i = new Intent(french8.this, french9.class);
                        startActivity(i);
                        bottomSheetDialog.hide();
                    }
                });
