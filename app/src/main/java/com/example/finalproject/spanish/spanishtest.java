...
import com.example.finalproject.italian.Aitalian1;
import com.example.finalproject.italian.italiantest;
import com.google.android.material.bottomsheet.BottomSheetDialog;

public class spanishtest extends AppCompatActivity {
    ImageView ib,ib1;
    EditText e1,e2;
    Button b,b1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_spanishtest);
        ...
        MediaPlayer mediaPlayer = MediaPlayer.create(this,R.raw.sta1);
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(spanishtest.this, home.class);
                startActivity(i);
                finish();
            }
        });
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(spanishtest.this);
...
//        Test 2
        MediaPlayer mediaPlayer1 = MediaPlayer.create(this,R.raw.sta2);
            ...
            public void onClick(View v) {
                if ((e2.getText().toString().trim().equals("a boy and a girl"))||(e2.getText().toString().trim().equals("A boy and a girl")))
                {
                    ...
                    button1.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent i = new Intent(spanishtest.this, Aspanish1.class);
                            startActivity(i);
                            bottomSheetDialog.hide();
                        }
                    });
