...
public class Aenglish10 extends AppCompatActivity {
    LottieAnimationView l1;
    Button f1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_aenglish10);
        ...
        f1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Aenglish10.this, ESplashScreen4.class);
                startActivity(i);
            }
        });
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Aenglish10.this, home.class);
                startActivity(i);
                finish();
            }
        });
