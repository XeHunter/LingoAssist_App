...
public class Aitalian8 extends AppCompatActivity {
    ImageView ib;
    EditText e1;
    Button b;
    TextToSpeech tts;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aitalian8);
        getSupportActionBar().hide();
        ib = findViewById(R.id.ib2);
        e1 = findViewById(R.id.ts1);
        b = findViewById(R.id.b1);
        b1 = findViewById(R.id.mic);
        MediaPlayer mediaPlayer = MediaPlayer.create(this,R.raw.ita8);
        mediaPlayer.start();
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Aitalian8.this, home.class);
                startActivity(i);
                finish();
            }
        });
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(Aitalian8.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        });
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(Aitalian8.this);
                ...
                else
                {
                    ...
                    button1.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent i = new Intent(Aitalian8.this, Aitalian9.class);
                            startActivity(i);
                            bottomSheetDialog.hide();
                        }
                    });
